...
def load_language_model():
    ...
    learn_language_model = language_model_learner(data_lm, AWD_LSTM, pretrained=False).load(path_learn_lm, with_opt=False)
...
def load_classification_nlp():
    ...
    learn_classification_nlp = text_classifier_learner(data_class, AWD_LSTM, pretrained=False).load(path_learn_class, with_opt=False)
